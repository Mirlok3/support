        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="bg-white border border-secondary p-3 rounded-2">
                    ...
                    <form action="{{ route('ticket.update', $ticket->id) }}" class="bg-white p-2" method="POST"
                        ...
                        <div class="d-flex justify-content-between m-2">
                            <div class="form-group m-2 col-md-7">
                                ...
                                <input type="file" class="form-control" name="file" placeholder="1234 Main St"
                                       value="{{ $ticket->file }}" accept="image/*">
                            </div>
                            ...
                            <div class="form-group m-2 col-md-3">
                                ...
                                <select name="department" class="form-select" aria-label="Default select example">
                                    <option selected
                                            value="{{ $departments[0]->id }}">{{ $departments[0]->name }}</option>
